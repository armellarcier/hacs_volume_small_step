...
Adds two actions to the media_player domain:
  - media_player.volume_up_small
  - media_player.volume_down_small
...
async def async_setup(hass: HomeAssistant, config: dict[str, Any]) -> bool:
    """Set up the volume_small_step integration."""
    ...
    _LOGGER.info(
        "volume_small_step integration loaded — services registered: %s.%s, %s.%s",
